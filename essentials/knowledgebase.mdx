...
Be careful: you can not upload files bigger than 50MB. If you try so, the upload will automatically be denied. Each user has a storage limit of 50MB, but we are working on raising the limit soon.